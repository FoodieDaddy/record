...
public class NicknameGenerator {
    ...
    private static final String[] NOUN4 = {
            // -- 原有 --
            "无心无爱", "人菜瘾大", "欧气满满", "佛系打牌", "顶级折磨",
            "欧皇降临", "带刀侍卫",
            "炸弹狂魔",
            // -- 扩充 --
            "屡战屡败", "屡败屡战", "阳光开朗", "阴暗爬行", "血压飙升",
            "漏网之鱼", "黄金矿工", "在逃公主","天选之子","摸鱼大师","散财童子","点炮大王","非酋附体",
            "精神小伙", "纯爱战神", "嘴强王者","慈善大师",
    ...
    private static final String[] NOUN5_6 = {
            ...
            "专业发牌员",
            // -- 扩充 --
            "顶级折磨王", "峡谷养爹人", "宇宙倒霉蛋", "纯血非酋长", "资深大冤种",
            "摸鱼天花板", "毫无参与感", "资深划水员", "局外观察员", "人形提款机",
            "随时会掉线", "只打顺风局", "被迫营业的",
    };

    /** 1~2 字符称呼/头衔 */
    private static final String[] NAME2 = {
            "雀神", "雀圣", "雀帝", "雀王", "雀仙", "雀侠", "牌王",
            "杠精", "内鬼", "卧底", "狼人", "地主", "农民", "舔狗", "吗喽",
            "老六", "棋王", "棋圣", "牌仙", "牌侠","懂王", "卷王",
