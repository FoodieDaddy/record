...
var MBTI_MAP = {
  ...
  11: { type: 'ESTJ', title: '规则型压制者' },
  12: { type: 'ESFJ', title: '协同型支援者' },
  13: { type: 'ISTP', title: '冷启动猎手' },
  14: { type: 'ISFP', title: '低频型感知者' },
  15: { type: 'ESTP', title: '高压型突击者' },
  16: { type: 'ESFP', title: '现场型爆发者' }
};
...
var MBTI_TRAITS = {
  ...
  ISFJ: ['防守稳固', '稳定输出', '风险规避', '持久耐力'],
  ESTJ: ['规则压制', '节奏控制', '高压执行', '结构化打法'],
  ESFJ: ['协同支援', '团队配合', '节奏感知', '稳定贡献'],
  ISTP: ['冷启动分析', '精准出手', '独立决策', '效率优先'],
  ISFP: ['低频感知', '直觉捕捉', '柔韧应变', '安静观察'],
  ESTP: ['高压突击', '即时反应', '冒险决策', '高频进攻'],
  ESFP: ['现场爆发', '即时反应', '高频决策', '情绪驱动']
};
